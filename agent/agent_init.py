...
def init_agent(
    ...
    agent._cache_ttl = "5m"
    try:
        from nazar_cli.config import load_config as _load_pc_cfg
    ...
    from nazar_logging import setup_logging, setup_verbose_logging
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        if _is_bedrock_anthropic:
            ...
            if agent.provider == "minimax-oauth" and isinstance(effective_key, str) and effective_key:
                try:
                    from nazar_cli.auth import build_minimax_oauth_token_provider
        ...
        try:
            from nazar_cli.config import load_config as _load_br_cfg
    ...
    try:
        from nazar_cli.config import load_config as _load_sess_cfg
    ...
    try:
        from nazar_cli.config import load_config as _load_agent_config
            ...
            if _mem_provider_name and _mem_provider_name.strip():
                ...
                if agent._memory_manager.providers:
                    ...
                    try:
                        ...
                        _init_kwargs["agent_workspace"] = "nazar"
                    except Exception:
                        pass
    ...
    if _config_context_length is None and _custom_providers:
        try:
            from nazar_cli.config import get_custom_provider_context_length
    ...
    if _engine_name != "compressor":
        ...
        if _selected_engine is None:
            try:
                from nazar_cli.plugins import get_plugin_context_engine
    ...
    if _ctx and _ctx < MINIMUM_CONTEXT_LENGTH:
        raise ValueError(
            ...
            f"by Nazar Agent.  Choose a model with at least "

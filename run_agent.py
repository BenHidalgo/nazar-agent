...
from nazar_cli.timeouts import (
...
class AIAgent:
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int] = None) -> None:
        ...
        try:
            ...
            from nazar_cli.models import ensure_lmstudio_model_loaded
    ...
    def _try_refresh_copilot_client_credentials(self) -> bool:
        ...
        try:
            from nazar_cli.copilot_auth import resolve_copilot_token
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        """
        if base_url_host_matches(self._base_url_lower, "nousresearch.com") or base_url_host_matches(self._base_url_lower, "nazar-agent.local"):
            return True
        ...
        if (
            ...
            try:
                from nazar_cli.models import github_model_reasoning_efforts
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        if cached is not None:
            ...
            if opts or (_time.monotonic() - ts) < 60:
                return opts
        try:
            from nazar_cli.models import lmstudio_model_reasoning_options

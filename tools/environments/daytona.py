...
class DaytonaEnvironment(BaseEnvironment):
    ...
    def __init__(
        ...
        self._sync_manager = FileSyncManager(
            get_files_fn=lambda: iter_sync_files(f"{self._remote_home}/.nazzar"),
    ...
    def _daytona_bulk_download(self, dest: Path) -> None:
        """Download remote .nazzar/ as a tar archive."""
        rel_base = f"{self._remote_home}/.nazzar".lstrip("/")
        ...
        remote_tar = f"/tmp/.nazzar_sync.{os.getpid()}.tar"

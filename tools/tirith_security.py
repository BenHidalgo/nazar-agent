...
it is automatically downloaded from GitHub releases to $NAZAR_HOME/bin/tirith.
...
def _install_tirith(*, log_failures: bool = True) -> tuple[str | None, str]:
    """Download and install tirith to $NAZAR_HOME/bin/tirith.
...
def _resolve_tirith_path(configured_path: str) -> str:
    ...
    2. $NAZAR_HOME/bin/tirith (previously auto-installed)
    3. Auto-install from GitHub releases → $NAZAR_HOME/bin/tirith

...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("update", "Update Nazar Agent to the latest version", "Info"),
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("nazar", "Talk to Hermes or run a subcommand", "[subcommand] [args]"))
    seen.add("nazar")
...
class SlashCommandCompleter(Completer):
    ...
    def _skin_completions(sub_text: str, sub_lower: str):
        ...
        try:
            from nazar_cli.skin_engine import list_skins
            for s in list_skins():
                name = s["name"]

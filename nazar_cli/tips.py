...
TIPS = [
    ...
    "Each profile gets its own subprocess HOME at NAZAR_HOME/home/ — isolated git, ssh, npm, gh configs.",
    "NAZAR_HOME_MODE env var (octal, e.g. 0701) sets custom directory permissions for web server traversal.",
    "Container mode: place .container-mode in NAZAR_HOME and the host CLI auto-execs into the container.",

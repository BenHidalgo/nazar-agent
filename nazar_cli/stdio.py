...
def _augment_path_with_known_tools() -> None:
    ...
    *spawned* processes only — already-running shells (including the one the
    ...
    # see on next launch.
    candidate_dirs = [
        os.path.join(local_appdata, "nazar", "git", "cmd"),
        os.path.join(local_appdata, "nazar", "git", "bin"),
        os.path.join(local_appdata, "nazar", "git", "usr", "bin"),
        ...
        os.path.join(local_appdata, "nazar", "hermes-agent", "venv", "Scripts"),

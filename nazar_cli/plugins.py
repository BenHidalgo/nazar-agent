...
4. **Pip plugins**     – packages that expose the ``nazar_agent.plugins``
   entry-point group.
...
ENTRY_POINTS_GROUP = "nazar_agent.plugins"
...
class PluginContext:
    ...
    def register_auxiliary_task(
        ...
        *,
        ...
        from nazar_cli.main import _AUX_TASKS as _BUILTIN_AUX_TASKS
...
class PluginManager:
    ...
    def discover_and_load(self, force: bool = False) -> None:
        ...
        user_dir = get_nazar_home() / "plugins"

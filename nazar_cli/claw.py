...
from nazar_cli.config import get_hermes_home, get_config_path, load_config, save_config
...
def _cmd_migrate(args):
    ...
    if not no_backup:
        try:
            from nazar_cli.backup import create_pre_migration_backup, _format_size

...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Nazar Agent"          # Banner title, status display
...
.. code-block:: python
    ...
    from nazar_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Nazar Agent"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "🧿 Nazar — the watcher, gold and cobalt",
        "colors": {
        ...
        "branding": {
            "agent_name": "Nazar Agent",
            "welcome": "Welcome to Nazar Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " 🧿 Nazar ",
            "prompt_symbol": "❯",

...
# argparse runs (it sets ``NAZAR_HOME`` and strips itself from ``sys.argv``),
...
def build_top_level_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="nazar",
        description="Nazar Agent - AI assistant with tool-calling capabilities",
    ...
    chat_parser = subparsers.add_parser(
        ...
        description="Start an interactive chat session with Nazar Agent",
    )

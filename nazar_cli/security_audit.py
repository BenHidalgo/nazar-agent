"""On-demand supply-chain audit for Nazar Agent installs.
...
def _discover_mcp() -> list[Component]:
    ...
    try:
        from nazar_cli.mcp_config import _get_mcp_servers
    except Exception:
        return []
...
def run_audit(
    *,
    ...
    home = hermes_home or Path(get_nazar_home())

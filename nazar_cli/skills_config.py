"""
Skills configuration for Nazar Agent.
...
from nazar_cli.config import cfg_get, load_config, save_config
from nazar_cli.colors import Colors, color
from nazar_cli.platforms import PLATFORMS as _PLATFORMS
